...
#     # ====== Begin: Throughput Timing Setup ======
#     warmup_batches = 20
#     total_images = 0
#     total_time = 0.0
#     timing_start = None
#     # ====== End: Throughput Timing Setup ======
...
#         if data_iter_step == warmup_batches:
#             torch.cuda.synchronize()
#             timing_start = time.time()

#         if data_iter_step >= warmup_batches:
#             total_images += samples.size(0)
...
#     # ====== Begin: Print Throughput Summary ======
#     if timing_start is not None:
#         torch.cuda.synchronize()
#         total_time = time.time() - timing_start
#         effective_batches = data_iter_step + 1 - warmup_batches
#         avg_batch_time = total_time / max(effective_batches, 1)
#         throughput = total_images / total_time

#         print("\n===== TIMING SUMMARY (after warm-up) =====")
#         print(f"Total images trained: {total_images}")
#         print(
#             f"Total batches timed (after {warmup_batches} warmup batches): {effective_batches}"
#         )
#         print(f"Total time: {total_time:.4f} seconds")
#         print(f"Average batch time: {avg_batch_time:.4f} seconds")
#         print(f"Throughput: {throughput:.2f} images/sec")
#         print("===========================================\n")
#     # ====== End: Print Throughput Summary ======
